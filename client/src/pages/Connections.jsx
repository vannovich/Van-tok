        ...
        <div className="inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm">
          {dataArray.map((item, index) => (
            <button
              ...
              key={index}
              className={`cursor-pointer flex items-center px-3 py-1 text-sm rounded-md transition-colors ${currentTab === item.label ? "bg-white font-medium text-black" : "text-gray-500 hover:text-black"}`}
            >
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    {currentTab === "Connections" && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-800 active:scale-95 transition cursor-pointer text-center justify-center gap-1"
                      >
